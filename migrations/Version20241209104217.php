 ...
 */
final class Version20241209104217 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, username VARCHAR(255) NOT NULL, is_enabled BOOLEAN NOT NULL, PRIMARY KEY(id))');
